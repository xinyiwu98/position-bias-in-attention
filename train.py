...
def main(args):
    ...
    model = SAN(in_channels=dim_features, hidden_channels=dim_features, out_channels=32, mask_type=mask_type, pe=pe, gamma=gamma, num_attn_layers=num_attn_layers, num_prefixes=num_prefixes, window_size=window_size).to(device)
